...
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Product_Solr_Linda]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Product_Solr_Linda]
GO
CREATE PROCEDURE Product_Solr_Linda
AS
BEGIN
SET NOCOUNT ON;
