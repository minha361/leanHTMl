package com.adr.bigdata.search.product;

/**
 * Lớp này chứa tất cả các hàm cũng như phương thức để lấy được tên trường trong core product nhé.
 * Các trường thường thì lấy field là đủ, còn các trường động thì dùng function
 * @author noind
 *
 */
