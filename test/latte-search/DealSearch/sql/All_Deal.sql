...
-- Altered by HungLS on 2016.01.15: support index mc_id and mc_name for CM team
-- =============================================
...
BEGIN
	...
	SELECT 
		...
		D.Visible,
		City.CityIds,
		MerchantDetail.MID AS MerchantId,
	...
	FROM
		...
		LEFT JOIN MerchantDetail ON D.MDID=MerchantDetail.MDID 
		LEFT JOIN Merchant ON MerchantDetail.MID=Merchant.MID 
	SET NOCOUNT OFF;
END
GO