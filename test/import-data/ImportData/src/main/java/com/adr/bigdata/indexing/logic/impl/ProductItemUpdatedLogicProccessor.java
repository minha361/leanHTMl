...
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ATT_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ATT_NAME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ATT_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ATT_VALUE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ATT_VALUE_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_BARCODE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_BRAND_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_BRAND_NAME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_BRAND_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_CATEGORY_PATH;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_CATEGORY_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_CAT_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_CREATE_TIME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_FRESH_FOOD_TYPE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_IMAGE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_IS_VISIBLE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_MC_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_MC_NAME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_MC_PI_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_MC_SKU;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_MERCHANT_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_ORI_PRICE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRICE_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRODUCT_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRODUCT_ITEM_NAME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRODUCT_ITEM_POLICY;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRODUCT_ITEM_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PRODUCT_ITEM_TYPE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_PROVINCE_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_QUANTITY;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_SAFETY_STOCK;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_SELL_PRICE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_SOLR_FE_PRODUCT_ATTRIBUTE;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_UPDATE_TIME;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_VAT_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_WAREHOUSE_STATUS;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_WEIGHT;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_WH_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_WH_PI_MAPPING;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_WH_PI_MAPPING_ID;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_IS_NOT_APPLY_COMMISION;
import static com.adr.bigdata.indexing.models.impl.ProductItemModel.PI_COMMISION_FEE;
...
import com.adr.bigdata.indexing.models.impl.ProductItemModel;
...
public class ProductItemUpdatedLogicProccessor extends BaseLogicProcessor {
	...
	private void updateProductItem(Collection<PuObject> productItems) throws Exception {
		...
		Map<Integer, Long> lastUpdateTimeOfProductItemCreates = productItemModel
				.getLastUpdateTimeOfProductItemCreates(setPiIds);
		Map<Integer, Long> lastUpdateTimeOfProductItemUpdates = productItemModel
				.getLastUpdateTimeOfProductItemUpdates(setPiIds);
		Map<Integer, BrandBean> cachedBrandBeans = brandModel.getBrandsByCache(brandIds);
		// Map<Integer, CategoryBean> cachedCategoryBeans = categoryModel.getCategoriesByCache(categoryIds);
		...
		if (!piIds.isEmpty()) {
			...
			productItemModel.updateToSolrForUpdate(piInfos, piId2ProductItem);

			productItemModel.updateToCacheForUpdate(piInfos, piId2ProductItem);
		}
	}
}
