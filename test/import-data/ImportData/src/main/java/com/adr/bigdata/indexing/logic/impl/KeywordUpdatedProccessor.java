...
import com.adr.bigdata.indexing.models.impl.KeywordModel;
...
public class KeywordUpdatedProccessor extends BaseLogicProcessor {
	...
	public void execute(PuObject data) throws Exception {
		...
		KeywordBean _bean = keywordModel.get(keyword);
		if (_bean != null && _bean.getUpdateTime() > updateTime) {
