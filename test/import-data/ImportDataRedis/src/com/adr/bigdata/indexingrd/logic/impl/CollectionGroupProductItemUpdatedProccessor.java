...
import com.adr.bigdata.indexingrd.models.impl.CollectionGroupProductItemModel;
...
//		}
		...
		Map<String, String> lastUpdateTimes = model.getLastUpdateTimes(collectionGroupId);
		...
		model.updateToRedis(collectionGroupId, updatedBeans);
		model.updateTimeToCache(collectionGroupId, updatedBeans, updateTime);
		model.sendLastUpdatedWhpIdsInteger(warehouseProductItemMappingIds);
		
		

		getProfillingLogger().debug("total time proccess {} of collectionGroupProduct is {}", 0,
